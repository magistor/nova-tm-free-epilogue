...
import l2p.Config;
import l2p.status.gshandlers.HandlerBan;
import l2p.status.gshandlers.HandlerDebug;
import l2p.status.gshandlers.HandlerNoChannel;
import l2p.status.gshandlers.HandlerPerfomance;
import l2p.status.gshandlers.HandlerSay;
import l2p.status.gshandlers.HandlerStats;
import l2p.status.gshandlers.HandlerStatus;
import l2p.status.gshandlers.HandlerWorld;
...
public class GameStatusThread extends Thread
{
	...
	public GameStatusThread(Socket client, String StatusPW) throws IOException
	{
		...
		_print.println("Welcome to the L2Phoenix GameServer Telnet Session.");
