...
public class L2CommandChannel {
	...
	public boolean meetRaidWarCondition(L2Object obj) {
		...
		switch(npcId) {
			...
			case 29020: // Baium
				return getMemberCount() > 55;
			case 29019: // Antharas
				return getMemberCount() > 224;
			case 29028: // Valakas
				return getMemberCount() > 99;
			default: // normal Raidboss
				return getMemberCount() > 17;
		}
	}
	...
	public static boolean checkAuthority(L2Player creator) {
		...
		if (creator.getParty().isLeader (creator)) {
			if (creator.getClan() != null && creator.getPledgeClass() > L2Player.RANK_WISEMAN) return true;
			else if (haveSkill && creator.getPledgeClass() > L2Player.RANK_KNIGHT) return true;
		} 
		return false;
	}
}