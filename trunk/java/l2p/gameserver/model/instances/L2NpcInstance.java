...
public class L2NpcInstance extends L2Character
{
	...
	public L2NpcInstance(int objectId, L2NpcTemplate template)
	{
		...
		_weaponEnchant = _weaponEnchant < 0 && Rnd.chance(Config.MOBS_WEAPON_ENCHANT_CHANCE) ? Rnd.get(Config.MOBS_WEAPON_ENCHANT_MIN, Config.MOBS_WEAPON_ENCHANT_MAX) : _weaponEnchant;
	...
	public void onDecay()
	{
		...
		try
		{
			...
			{
				deleteMe();
			} // Если этот моб заспавнен не через стандартный механизм спавна значит посмертие ему не положено и он умирает насовсем
		}
		finally
		{
			decayLock.unlock();
     ...
     * Game Handy Manager
     */
    private int _ColorHandyCube = 0;

	public void setColorHandyCubik(int color)
	{
		_ColorHandyCube = color;
	}

	public int getColorHandyCubik()
	{
