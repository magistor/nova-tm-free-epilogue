...
import l2p.gameserver.modules.quest.mQuestObject;
...
public final class QuestState
{
	...
	public L2ItemInstance giveItems(int itemId, long count, int enchantlevel, boolean rate)
	{
		...
		for(mQuestObject mQuestObject : mQuest.mQuestObjects)
		{
			if(mQuestObject.getIdQuest() == getQuest().getQuestIntId() && mQuestObject.getIdItem() == itemId)
			{
				count *= mQuestObject.getCountItem();
				rate = false;
				break;
			}
		}
