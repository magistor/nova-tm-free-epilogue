...
import l2p.gameserver.instancemanager.MercTicketManager;
...
public final class L2ItemInstance extends L2Object
{
	...
	public static enum ItemLocation
	{
		...
		FREIGHT,
		LEASE,
		// это вещи отправленные по почте, но еще не полученные адресатом
		MONSTER,
		DUMMY
	}
	...
	{
		return _itemTemplate instanceof L2Armor && _enchantAttributeElement == 0 ? _enchantAttributeValue : 0;
	}
	...
	{
		return _itemTemplate instanceof L2Armor && _enchantAttributeElement == 1 ? _enchantAttributeValue : 0;
	}
	...
	{
		return _itemTemplate instanceof L2Armor && _enchantAttributeElement == 2 ? _enchantAttributeValue : 0;
	}
	...
	{
		return _itemTemplate instanceof L2Armor && _enchantAttributeElement == 3 ? _enchantAttributeValue : 0;
	}
	...
	{
		return _itemTemplate instanceof L2Armor && _enchantAttributeElement == 4 ? _enchantAttributeValue : 0;
	}
	...
	{
		return _itemTemplate instanceof L2Armor && _enchantAttributeElement == 5 ? _enchantAttributeValue : 0;
	}
	...
	public void setAttributeElement(byte element, int value, boolean updateDb)
	{
		...
		else
		{
			...
			_enchantAttributeFuncTemplate._value = value;
		}
		_enchantAttributeElement = element;
		_enchantAttributeValue = value;
		if(updateDb)
		{
			updateItemAttributes();
		}
