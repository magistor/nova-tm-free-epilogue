...
import static l2p.gameserver.model.base.ClassType.Bard;
import static l2p.gameserver.model.base.ClassType.BowMaster;
import static l2p.gameserver.model.base.ClassType.DaggerMaster;
import static l2p.gameserver.model.base.ClassType.Enchanter;
import static l2p.gameserver.model.base.ClassType.Fighter;
import static l2p.gameserver.model.base.ClassType.ForceMaster;
import static l2p.gameserver.model.base.ClassType.Healer;
import static l2p.gameserver.model.base.ClassType.Mystic;
import static l2p.gameserver.model.base.ClassType.Priest;
import static l2p.gameserver.model.base.ClassType.ShieldMaster;
import static l2p.gameserver.model.base.ClassType.Summoner;
import static l2p.gameserver.model.base.ClassType.WeaponMaster;
import static l2p.gameserver.model.base.ClassType.Wizard;
...
public enum PlayerClass
{
	...
	//124
	Troopier(kamael, Fighter, Second),
	// 125
	 ...
	 * kamael
	 */
	Doombringer(kamael, Fighter, Fourth, WeaponMaster),
	//131
	MaleSoulHound(kamael, Fighter, Fourth, WeaponMaster),
	//132
	FemaleSoulHound(kamael, Fighter, Fourth, WeaponMaster),
	//133
	Trickster(kamael, Fighter, Fourth, BowMaster),
	//134
