...
public class SevenSignsFestival
{
	...
	public static String implodeString(GArray<?> strArray)
	{
	...
	public void resetFestivalData(boolean updateSettings)
	{
		...
		for(L2Player onlinePlayer : L2ObjectsStorage.getAllPlayers())
		{
	...
	{
		GArray<Integer> partyMemberIds = party.getPartyMembersObjIds();
		GArray<L2Player> partyMembers = party.getPartyMembers();
