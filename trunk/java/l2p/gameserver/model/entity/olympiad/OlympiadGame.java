...
import l2p.gameserver.model.instances.L2OlympiadManagerInstance;
	...
	public void managerShout()
	{
		try
		{
			for(L2OlympiadManagerInstance npc : Olympiad.getNpcs())
			{
				...
				{
					say(npc, "l2p.gameserver.model.entity.OlympiadGame.OlympiadClassed", _id + 1);
				}
				else if(_type == CompType.TEAM || _type == CompType.TEAM_RANDOM)
				{
					say(npc, "l2p.gameserver.model.entity.OlympiadGame.OlympiadTeam", _id + 1);
				}
				else
				{
					say(npc, "l2p.gameserver.model.entity.OlympiadGame.OlympiadNonClassed", _id + 1);
				}
			}
		}
		catch(Exception e)
