...
public enum AbnormalEffect
{
	...
	// Большая круглая желтая прическа с воткнутой в волосы расческой
	S_PINK_AFFRO("pinkafro", 0x00000020, true),
	// Большая круглая розовая прическа с воткнутой в волосы расческой
	S_BLACK_AFFRO("blackafro", 0x00000040, true),
	// Большая круглая черная прическа с воткнутой в волосы расческой
	...
	// пусто
	S_UNKNOWN11("sunk11", 0x00000400, true),
	// пусто
	S_UNKNOWN12("sunk12", 0x00000800, true),
	// пусто
	S_UNKNOWN13("sunk13", 0x00001000, true),
	// пусто
	S_UNKNOWN14("sunk14", 0x00002000, true),
	// пусто
	S_UNKNOWN15("sunk15", 0x00004000, true),
	// пусто
	S_UNKNOWN16("sunk16", 0x00008000, true),
	// пусто
	...
	// пусто
	S_UNKNOWN20("sunk20", 0x00080000, true),
	// пусто
