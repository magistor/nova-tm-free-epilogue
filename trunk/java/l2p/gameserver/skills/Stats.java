...
public enum Stats
{
	...
	MAX_HP("maxHp", 1, 40000, true),
	MAX_MP("maxMp", 1, 40000, true),
	MAX_CP("maxCp", 1, 100000, true),
	...
	RUN_SPEED("runSpd", 0, Config.LIM_MOVE, true),
	POWER_DEFENCE("pDef", 0, Config.LIM_PDEF, true),
	MAGIC_DEFENCE("mDef", 0, Config.LIM_MDEF, true),
	POWER_ATTACK("pAtk", 0, Config.LIM_PATK, true),
	MAGIC_ATTACK("mAtk", 0, Config.LIM_MATK, true),
	POWER_ATTACK_SPEED("pAtkSpd", 0, Config.LIM_PATK_SPD, false),
	MAGIC_ATTACK_SPEED("mAtkSpd", 0, Config.LIM_MATK_SPD, false),
	...
	CRITICAL_DAMAGE("cAtk", 0, Config.LIM_CRIT_DAM / 2, false, new InitConst(100)),
	CRITICAL_DAMAGE_STATIC("cAtkStatic", null, null, false, new InitConst(0)),
	EVASION_RATE("rEvas", 0, Config.LIM_EVASION, false),
	ACCURACY_COMBAT("accCombat", 0, Config.LIM_ACCURACY, false),
	CRITICAL_BASE("baseCrit", 0, Config.LIM_CRIT, false, new InitConst(100)),
	CRITICAL_RATE("rCrit", 0, null, false, new InitConst(100)),
	MCRITICAL_RATE("mCritRate", 0, Config.LIM_MCRIT, false, new InitConst(10.)),
	...
	REFLECT_AND_BLOCK_DAMAGE_CHANCE("reflectAndBlockDam", 0, 100, false),
	// Ближний урон без скиллов
	REFLECT_AND_BLOCK_PSKILL_DAMAGE_CHANCE("reflectAndBlockPSkillDam", 0, 100, false),
	// Ближний урон скиллами
	REFLECT_AND_BLOCK_MSKILL_DAMAGE_CHANCE("reflectAndBlockMSkillDam", 0, 100, false),
	// Любой урон магией
	// Отражение урона в процентах. Урон получает и атакующий и цель
	REFLECT_DAMAGE_PERCENT("reflectDam", 0, 100, false),
	// Ближний урон без скиллов
	REFLECT_PSKILL_DAMAGE_PERCENT("reflectPSkillDam", 0, 100, false),
	// Ближний урон скиллами
	REFLECT_MSKILL_DAMAGE_PERCENT("reflectMSkillDam", 0, 100, false),
	// Любой урон магией
