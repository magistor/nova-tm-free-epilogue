...
public class AshurasofDestruction extends Fighter
{
  private ScheduledFuture<?> _SpawnTask;
  private static final int[] MOBS = { 21656 };
  public AshurasofDestruction(L2Character actor)
  {
    super(actor);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      AshurasofDestruction.this.Spawn(this._attacker);
    }
  }
}