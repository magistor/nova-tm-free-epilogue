...
public class AssassinofEmpire extends Fighter
{
  private ScheduledFuture<?> _SpawnTask;
  private static final int[] MOBS = { 21415 };
  public AssassinofEmpire(L2Character actor)
  {
    super(actor);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      AssassinofEmpire.this.Spawn(this._attacker);
    }
  }
}