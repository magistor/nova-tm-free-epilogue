...
public class ArimanesofDestruction extends Fighter
{
  private ScheduledFuture<?> _SpawnTask;
  private static final int[] MOBS = { 21392 };
  public ArimanesofDestruction(L2Character actor)
  {
    super(actor);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      ArimanesofDestruction.this.Spawn(this._attacker);
    }
  }
}