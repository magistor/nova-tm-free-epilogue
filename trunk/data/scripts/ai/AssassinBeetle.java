...
public class AssassinBeetle extends Fighter
{
  private ScheduledFuture<?> _SpawnTask;
  private static final int[] MOBS = { 21653 };
  public AssassinBeetle(L2Character actor)
  {
    super(actor);
  }
    ...
    implements Runnable
  {
    ...
    public void run()
    {
      AssassinBeetle.this.Spawn(this._attacker);
    }
  }
}