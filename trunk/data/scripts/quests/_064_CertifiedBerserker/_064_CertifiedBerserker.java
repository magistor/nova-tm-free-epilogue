...
public class _064_CertifiedBerserker extends Quest implements ScriptFile
{
	...
	public L2NpcInstance HARKILGAMED_SPAWN;
	...
	{
		HARKILGAMED_SPAWN = Functions.spawn(st.getPlayer().getLoc().rnd(50, 100, false), HARKILGAMED);
	}
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32207-03a.htm"))
		{
			...
			{
				st.addExpAndSp(174503, 11973, true);
				st.giveItems(ADENA_ID, 31552, Config.RATE_QUESTS_OCCUPATION_CHANGE);
