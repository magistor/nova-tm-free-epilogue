	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.length() == 1)
		{
			...
			else
			{
				if(cond == 1)
				{
					htmltext = Files.read("data/scripts/quests/_178_IconicTrinity/32255-03.htm", st.getPlayer());
				}
				else if(cond == 2)
				{
					htmltext = Files.read("data/scripts/quests/_178_IconicTrinity/32256-03.htm", st.getPlayer());
				}
				else
				{
					htmltext = Files.read("data/scripts/quests/_178_IconicTrinity/32257-03.htm", st.getPlayer());
				}
				if(len == 0)
				{
		...
		{
			htmltext = Files.read("data/scripts/quests/_178_IconicTrinity/" + event, st.getPlayer());
