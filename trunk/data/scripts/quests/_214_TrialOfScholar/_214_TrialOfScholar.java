...
public class _214_TrialOfScholar extends Quest implements ScriptFile
{
	...
	public String onKill(L2NpcInstance npc, QuestState st)
	{
		...
		{
			st.rollAndGive(Scripture_Chapter_3, 1, 1, 1, 30, true);
		}
		...
		{
			if(st.rollAndGive(Brown_Scroll_Scrap, 1, 1, 5, 50, true))
			{
				st.set("cond", "12");
			}
		}
		...
		{
			if(st.rollAndGive(Monster_Eye_Destroyer_Skin, 1, 1, 5, 50, true) && Check_cond17_items(st))
			{
				st.set("cond", "17");
			}
		}
		...
		{
			if(st.rollAndGive(Shamans_Necklace, 1, 1, 5, 50, true) && Check_cond17_items(st))
			{
				st.set("cond", "17");
			}
		}
		...
		{
			if(st.rollAndGive(Shackles_Scalp, 1, 1, 2, 50, true) && Check_cond17_items(st))
			{
				st.set("cond", "17");
			}
		}
		...
		{
			if(st.rollAndGive(Ghouls_Skin, 1, 1, 10, 100, true) && Check_cond29_items(st))
			{
				st.set("cond", "29");
			}
		}
		...
		{
			if(st.rollAndGive(Medusas_Blood, 1, 1, 12, 100, true) && Check_cond29_items(st))
			{
				st.set("cond", "29");
			}
		}
		...
		{
			if(st.rollAndGive(Fettered_Souls_Ichor, 1, 1, 5, 100, true) && Check_cond29_items(st))
			{
				st.set("cond", "29");
			}
		}
		...
		{
			if(st.rollAndGive(Enchanted_Gargoyles_Nail, 1, 1, 5, 100, true) && Check_cond29_items(st))
			{
				st.set("cond", "29");
			}
		}
