...
public class _212_TrialOfDuty extends Quest implements ScriptFile
{
	...
	public _212_TrialOfDuty()
	{
		...
		addQuestItem(new int[] {LETTER_OF_DUSTIN_ID, KNIGHTS_TEAR_ID, OLD_KNIGHT_SWORD_ID, TEAR_OF_CONFESSION_ID,
			MIRROR_OF_ORPIC_ID, TALIANUSS_REPORT_ID, MILITAS_ARTICLE_ID, ATEBALTS_SKULL_ID, ATEBALTS_RIBS_ID,
			ATEBALTS_SHIN_ID, LETTER_OF_WINDAWOOD_ID, TEAR_OF_LOYALTY_ID, SAINTS_ASHES_URN_ID, REPORT_PIECE_ID});
	}
