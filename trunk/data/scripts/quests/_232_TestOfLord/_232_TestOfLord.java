...
public class _232_TestOfLord extends Quest implements ScriptFile
{
	...
	// Items
	private static short MARK_OF_LORD = 3390;
	private static short BONE_ARROW = 1341;
	private static short Dimensional_Diamond = 7562;
	// Quest Items (Drop)
	private static short TIMAK_ORC_SKULL = 3403;
	private static short BREKA_ORC_FANG = 3398;
	private static short RAGNA_ORC_HEAD = 3414;
	private static short RAGNA_CHIEF_NOTICE = 3415;
	private static short MARSH_SPIDER_FEELER = 3407;
	private static short MARSH_SPIDER_FEET = 3408;
	private static short CORNEA_OF_EN_MONSTEREYE = 3410;
	// Quest Items
	private static short ORDEAL_NECKLACE = 3391;
	private static short VARKEES_CHARM = 3392;
	private static short TANTUS_CHARM = 3393;
	private static short HATOS_CHARM = 3394;
	private static short TAKUNA_CHARM = 3395;
	private static short CHIANTA_CHARM = 3396;
	private static short MANAKIAS_ORDERS = 3397;
	private static short MANAKIAS_AMULET = 3399;
	private static short HUGE_ORC_FANG = 3400;
	private static short SUMARIS_LETTER = 3401;
	private static short URUTU_BLADE = 3402;
	private static short SWORD_INTO_SKULL = 3404;
	private static short NERUGA_AXE_BLADE = 3405;
	private static short AXE_OF_CEREMONY = 3406;
	private static short HANDIWORK_SPIDER_BROOCH = 3409;
	private static short MONSTEREYE_WOODCARVING = 3411;
	private static short BEAR_FANG_NECKLACE = 3412;
	private static short MARTANKUS_CHARM = 3413;
	private static short IMMORTAL_FLAME = 3416;
	...
	public _232_TestOfLord()
	{
		...
		for(Drop _drop : DROPLIST.values())
		{
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(state == STARTED)
		{
			if(event.equalsIgnoreCase("30565-12.htm") && st.getQuestItemsCount(IMMORTAL_FLAME) > 0)
			{
				...
				{
					st.addExpAndSp(434000, 60000, true); // FIXME: цифра приблизительная
					st.giveItems(ADENA_ID, 100000, Config.RATE_QUESTS_OCCUPATION_CHANGE); // FIXME: с потолка
