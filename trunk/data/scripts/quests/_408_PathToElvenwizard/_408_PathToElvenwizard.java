...
public class _408_PathToElvenwizard extends Quest implements ScriptFile
{
	...
	public _408_PathToElvenwizard()
	{
		...
		addQuestItem(new int[] {ROGELLIAS_LETTER_ID, FERTILITY_PERIDOT_ID, IMMORTAL_LOVE_ID, APPETIZING_APPLE_ID,
			CHARM_OF_GRAIN_ID, MAGICAL_POWERS_RUBY_ID, SAP_OF_WORLD_TREE_ID, PURE_AQUAMARINE_ID, LUCKY_POTPOURI_ID,
			NOBILITY_AMETHYST_ID, GOLD_LEAVES_ID, RED_DOWN_ID, AMETHYST_ID});
	}
