...
public class _220_TestimonyOfGlory extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = {{1, 0, ManashenGargoyle, VokiansOrder, ManashenShard, 10, 70, 1},
	...
	public _220_TestimonyOfGlory()
	{
		...
		addQuestItem(new int[] {VokiansOrder, VokiansOrder2, NecklaceOfAuthority, ChiantaOrder1st, ManakiaLetter1st,
			ManakiaLetter2st, KasmansLetter1rd, KasmansLetter2rd, KasmansLetter3rd, ScepterOfBreka, PashikasHead,
			VultusHead, GloveOfVoltar, GloveOfKepra, ScepterOfEnku, ScepterOfTurek, GloveOfBurai, ScepterOfTunath,
			DrikosContract, ChiantasOrder2rd, ChiantasOrder3rd, ScepterBox, TanapisOrder, ScepterOfTantos, RitualBox,
			ManashenShard, TyrantTalon, GuardianBasiliskFang, StakatoDroneHusk, EnkuOverlordHead, MakumBugbearHead,
			TimakOrcHead, TamlinOrcSkull});
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Kakai && cond == 11)
		{
			...
			{
				st.addExpAndSp(724113, 48324, true);
				st.giveItems(ADENA_ID, 131360, Config.RATE_QUESTS_OCCUPATION_CHANGE);
