...
public class _410_PathToPalusKnight extends Quest implements ScriptFile
{
	...
	public _410_PathToPalusKnight()
	{
		...
		addQuestItem(new int[] {PALLUS_TALISMAN_ID, VIRGILS_LETTER_ID, COFFIN_ETERNAL_REST_ID, MORTE_TALISMAN_ID,
			PREDATOR_CARAPACE_ID, TRIMDEN_SILK_ID, LYCANTHROPE_SKULL_ID});
	}
