...
public class _120_PavelsResearch extends Quest implements ScriptFile
{
	...
	//ITEMS	
	private static final int EarBinding = 854;
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		else if(event.equalsIgnoreCase("32041-32.htm"))
		{
			...
			st.giveItems(EarBinding, 1, false);
			st.giveItems(ADENA_ID, 174160 + Math.round(Math.min(0, 227500 * (st.getRateQuestsReward() - 1))), true);
			st.addExpAndSp(766070, 60581, true);
