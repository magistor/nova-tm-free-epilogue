...
public class _218_TestimonyOfLife extends Quest implements ScriptFile
{
	...
	public _218_TestimonyOfLife()
	{
		...
		addKillId(20087);
		addKillId(20088);
		addQuestItem(new int[] {CAMOMILE_CHARM, CARDIENS_LETTER, WATER_OF_LIFE, MOONFLOWER_CHARM, HIERARCHS_LETTER,
			STARDUST, PURE_MITHRIL_CUP, THALIAS_INSTRUCTIONS, ISAELS_LETTER, TEARS_OF_UNICORN, GRAIL_DIAGRAM,
			PUSHKINS_LIST, THALIAS_LETTER1, ARKENIAS_CONTRACT, ANDARIEL_SCRIPTURE_COPY, ARKENIAS_INSTRUCTIONS,
			ADONIUS_LIST, THALIAS_LETTER2, TALINS_SPEAR_BLADE, TALINS_SPEAR_SHAFT, TALINS_RUBY, TALINS_AQUAMARINE,
			TALINS_AMETHYST, TALINS_PERIDOT, ISAELS_INSTRUCTIONS, GRAIL_OF_PURITY});
	}
