...
public class _105_SkirmishWithOrcs extends Quest implements ScriptFile
{
	...
	public _105_SkirmishWithOrcs()
	{
		...
		addQuestItem(new int[] {Kendells1stOrder, Kendells2stOrder, Kendells3stOrder, Kendells4stOrder, Kendells5stOrder,
			Kendells6stOrder, Kendells7stOrder, Kendells8stOrder, KabooChiefs1stTorque, KabooChiefs2stTorque});
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		else if(cond == 4 && st.getQuestItemsCount(KabooChiefs2stTorque) > 0)
		{
			...
			st.getPlayer().addExpAndSp(41478, 3555, false, false);
