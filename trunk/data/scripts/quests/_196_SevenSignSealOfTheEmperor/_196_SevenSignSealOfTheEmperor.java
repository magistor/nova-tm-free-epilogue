...
import l2p.util.Rnd;
import quests._195_SevenSignSecretRitualOfThePriests._195_SevenSignSecretRitualOfThePriests;
...
public class _196_SevenSignSealOfTheEmperor extends Quest implements ScriptFile
{
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npcId == IasonHeine)
		{
			if(id == CREATED)
			{
				...
				QuestState qs = player.getQuestState(_195_SevenSignSecretRitualOfThePriests.class);
	...
	private void enterInstance(L2Player player)
	{
		...
		FastMap<Integer, InstancedZoneManager.InstancedZone> ils = ilm.getById(instancedZoneId);
