...
public class _403_PathToRogue extends Quest implements ScriptFile
{
	...
	public final int[][] MobsTable = {{TRACKER_SKELETON, 2}, {TRACKER_SKELETON_LEADER, 3}, {SKELETON_SCOUT, 2},
		{SKELETON_BOWMAN, 2}, {RUIN_SPARTOI, 8}, {RAGING_SPARTOI, 8}};
	...
	public _403_PathToRogue()
	{
		...
		addQuestItem(new int[] {NETIS_BOW_ID, NETIS_DAGGER_ID, WANTED_BILL_ID, HORSESHOE_OF_LIGHT_ID, BEZIQUES_LETTER_ID,
			SPATOIS_BONES_ID});
	}
