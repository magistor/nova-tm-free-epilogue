...
public class _228_TestOfMagus extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = {
		...
		{5, 0, Harpy, SylphCharm, HarpysFeather, 20, 50, 2}, {5, 0, Wyrm, SylphCharm, WyrmsWingbone, 10, 50, 2},
	...
	public _228_TestOfMagus()
	{
		...
		addQuestItem(new int[] {RukalsLetter, ParinasLetter, LilacCharm, ToneOfWind, SylphCharm, SerpentCharm,
			ToneOfEarth, UndineCharm, ToneOfFire, SalamanderCharm, ToneOfWater, ScoreOfElements, GoldenSeed1st,
			GoldenSeed2st, GoldenSeed3st, HarpysFeather, WyrmsWingbone, WindsusMane, EnchantedMonsterEyeShell,
			EnchantedStoneGolemPowder, EnchantedIronGolemScrap, FlameCrystal, DazzlingDrop});
	}
