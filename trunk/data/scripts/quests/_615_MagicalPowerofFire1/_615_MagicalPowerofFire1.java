		...
		switch(npcId)
		{
			case NARAN:
				if(cond == 0)
				{
					...
					{
						if(st.getQuestItemsCount(MARK_OF_VARKA_ALLIANCE2) == 1 || st.getQuestItemsCount(MARK_OF_VARKA_ALLIANCE3) == 1 || st.getQuestItemsCount(MARK_OF_VARKA_ALLIANCE4) == 1 || st.getQuestItemsCount(MARK_OF_VARKA_ALLIANCE5) == 1)
						{
