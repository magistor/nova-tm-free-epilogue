...
public class _222_TestOfDuelist extends Quest implements ScriptFile
{
	...
	public _222_TestOfDuelist()
	{
		...
		addQuestItem(new int[] {OrderGludio, OrderDion, OrderGiran, OrderOren, OrderAden, FinalOrder});
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Kaien)
		{
			...
			else if(cond == 5)
			{
				...
				{
					st.addExpAndSp(474444, 30704, true);
					st.giveItems(ADENA_ID, 80000, Config.RATE_QUESTS_OCCUPATION_CHANGE); // FIXME: цифра с потолка
