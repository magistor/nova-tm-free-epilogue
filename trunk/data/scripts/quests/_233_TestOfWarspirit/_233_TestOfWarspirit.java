...
public class _233_TestOfWarspirit extends Quest implements ScriptFile
{
	...
	private static short[] Noble_Ant_Drops = {KIRUNAS_THIGH_BONE, KIRUNAS_ARM_BONE, KIRUNAS_SPINE, KIRUNAS_RIB_BONE,
		KIRUNAS_SKULL};
	private static short[] Leto_Lizardman_Drops = {TONARS_SKULL, TONARS_RIB_BONE, TONARS_SPINE, TONARS_ARM_BONE,
		TONARS_THIGH_BONE};
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(_state != STARTED || st.getInt("cond") != 1)
		{
			return "noquest";
		}
		if(npcId == Somak)
	...
	{
		if(qs.getState() != STARTED || qs.getInt("cond") < 1)
		{
			return null;
		}
		int npcId = npc.getNpcId();
		...
		{
			GArray<Integer> drops = new GArray<Integer>();
			for(short drop_id : Noble_Ant_Drops)
			{
