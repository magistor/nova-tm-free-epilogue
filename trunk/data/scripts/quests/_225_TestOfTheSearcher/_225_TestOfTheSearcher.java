...
public class _225_TestOfTheSearcher extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = {{3, 4, DeluLizardmanShaman, 0, DeluTotem, 10, 100, 1},
		{3, 4, DeluLizardmanAssassin, 0, DeluTotem, 10, 100, 1}, {10, 11, GiantFungus, 0, RedSporeDust, 10, 100, 1}};
	...
	public _225_TestOfTheSearcher()
	{
		...
		addQuestItem(new int[] {DeluTotem, RedSporeDust, LuthersLetter, AlexsWarrant, Leirynns1stOrder, Leirynns2ndOrder,
			LeirynnsReport, ChiefKalkisFang, StrangeMap, LambertsMap, AlexsLetter, AlexsOrder, WineCatalog, TyrasContract,
			OldOrder, MalrukianWine, JaxsDiary, TornMapPiece1st, TornMapPiece2st, SoltsMap, MakelsMap, RustedKey,
			CombinedMap});
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Luther)
		{
			...
			else if(cond == 19)
			{
				...
				{
					st.addExpAndSp(447444, 30704, true);
					st.giveItems(ADENA_ID, 80093, Config.RATE_QUESTS_OCCUPATION_CHANGE);
