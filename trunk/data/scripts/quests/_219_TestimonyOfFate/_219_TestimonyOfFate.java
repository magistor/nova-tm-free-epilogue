...
public class _219_TestimonyOfFate extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = {{6, 0, Medusa, IxiasList, MedusasIchor, 10, 100, 1},
	...
	public _219_TestimonyOfFate()
	{
		...
		addQuestItem(new int[] {KairasLetter, MetheussFuneralJar, KasandrasRemains, IxiasList, Belladonna, AldersSkull1,
			AldersSkull2, AldersReceipt, RevelationsManuscript, KairasRecommendation, KairasInstructions, ThifiellsLetter,
			PalusCharm, ArkeniasNote, PixyGarnet, BlightTreantSeed, RedFairyDust, BlightTreantSap, ArkeniasLetter,
			MedusasIchor, MarshSpiderFluids, DeadSeekerDung, TyrantsBlood, NightshadeRoot, GrandissSkull,
			KarulBugbearSkull, BrekaOverlordSkull, LetoOverlordSkull, BlackWillowLeaf});
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		else if(npcId == Thifiell)
		{
			...
			else if(cond == 18)
			{
				...
				{
					st.addExpAndSp(682735, 45562, true);
					st.giveItems(ADENA_ID, 123854, Config.RATE_QUESTS_OCCUPATION_CHANGE);
