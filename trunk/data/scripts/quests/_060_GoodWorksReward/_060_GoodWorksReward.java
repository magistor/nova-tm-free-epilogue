...
public class _060_GoodWorksReward extends Quest implements ScriptFile
{
	...
	{
		return L2ObjectsStorage.contains(Last_Spawned_Pursuer);
	}
	...
	public String onEvent(String event, QuestState st, L2NpcInstance npc)
	{
		...
		{
			L2NpcInstance n = st.addSpawn(Pursuer, 72590, 148100, -3320, 1800000);
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(_state == CREATED)
		{
			...
			if(!Config.ALLOW_SHORT_2ND_PROF_QUEST)
			{
				Functions.show(new CustomMessage("common.Disabled", st.getPlayer()), st.getPlayer());
				return null;
			}
	...
	private static final FastMap<String, int[]> marks = new FastMap<String, int[]>();
