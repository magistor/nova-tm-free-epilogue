...
public class _221_TestimonyOfProsperity extends Quest implements ScriptFile
{
	...
	private static final int[][] DROPLIST_COND = {{1, 0, MandragoraSprout, BrightsList, MandragoraPetal, 20, 60, 1},
		...
		{7, 0, MarshStakato, 0, StakatoShell, 20, 100, 1}, {7, 0, MarshStakatoWorker, 0, StakatoShell, 20, 100, 1},
		{7, 0, MarshStakatoSoldier, 0, StakatoShell, 20, 100, 1},
		{7, 0, MarshStakatoDrone, 0, StakatoShell, 20, 100, 1}, {7, 0, ToadLord, 0, ToadLordSac, 10, 100, 1},
	...
	public _221_TestimonyOfProsperity()
	{
		...
		addQuestItem(new int[] {RingOfTestimony1st, BrightsList, MandragoraBouquet, BlessedSeed, EmilysRecipe,
			CrystalBrooch, LilithsElvenWafer, CollectionLicense, Lockirins1stNotice, Lockirins2stNotice,
			Lockirins3stNotice, Lockirins4stNotice, Lockirins5stNotice, ReceiptOfContribution1st, ReceiptOfContribution2st,
			ReceiptOfContribution3st, ReceiptOfContribution4st, ReceiptOfContribution5st, OldAccountBook,
			ContributionOfShari, ContributionOfMaryse, ContributionOfMion, ProcurationOfTorocco, ReceiptOfBolter,
			ContributionOfToma, MarysesRequest, ParmansInstructions, RingOfTestimony2st, MaphrTabletFragment,
			PatternOfKeyhole, ClayDough, NikolasList, MandragoraPetal, CrimsonMoss, StakatoShell, ToadLordSac, SpiderThorn});
	}
	...
	public String onTalk(L2NpcInstance npc, QuestState st)
	{
		...
		if(npcId == Parman)
		{
			...
			else if(cond == 9)
			{
				...
				{
					st.addExpAndSp(599979, 40040, true);
					st.giveItems(57, 108841, Config.RATE_QUESTS_OCCUPATION_CHANGE);
