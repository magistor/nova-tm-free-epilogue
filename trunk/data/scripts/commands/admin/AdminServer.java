			...
			case admin_test:
				...
				try
				{
					...
					*/
					...
					java.lang.reflect.Field interestPool = Class.forName("l2p.extensions.network.MMOConnection").getDeclaredField("interestPool");
					...
					java.lang.reflect.Constructor<?> con = Class.forName("l2p.extensions.network.MMOConnection$ScheduleInterest").getDeclaredConstructor(Class.forName("l2p.extensions.network.MMOConnection"));
