...
public class ItemHandlers extends Functions
{
	...
	//Newbie Level-Up Pack
	
	public void ItemHandler_20397(L2Player player, Boolean ctrl)
	{
		if(player == null)
		{
			return;
		}
		if(!canBeExtracted(20397, player))
		{
			return;
		}
		int[] list = new int[] {1060, 5539, 5789, 5790, 6354, 6355, 9191, 13121};
		int[] counts = new int[] {20, 1, 1000, 1000, 1, 1, 1, 1}; //TODO: correct count
		int[] chances = new int[] {100, 100, 100, 100, 100, 100, 33}; //TODO: correct chance
		removeItem(player, 20397, 1);
		extract_item_r(list, counts, chances, player);
	}
	//Purple-Maned Horse 7-Day Pack 
	
	public void ItemHandler_13121(L2Player player, Boolean ctrl)
	{
		if(player == null)
		{
			return;
		}
		if(!canBeExtracted(13121, player))
		{
			return;
		}
		removeItem(player, 13121, 1);
		addItem(player, 13022, 1);
	}
	//Gold Maned Lion Mounting Bracelet 7 Day Pack 
	
	public void ItemHandler_14231(L2Player player, Boolean ctrl)
	{
		if(player == null)
		{
			return;
		}
		if(!canBeExtracted(14231, player))
		{
			return;
		}
		removeItem(player, 14231, 1);
		addItem(player, 14053, 1);
	}
	//Steam Beatle Mounting Bracelet 7 Day Pack 
	
	public void ItemHandler_14232(L2Player player, Boolean ctrl)
	{
		if(player == null)
		{
			return;
		}
		if(!canBeExtracted(14232, player))
		{
			return;
		}
		removeItem(player, 14232, 1);
	...
	public void ItemHandler_20210(L2Player player, Boolean ctrl)
	{
		...
		} //Agathion Seal Bracelet - Charming Cupid 
		if(Rnd.chance(100))
		{
			addItem(player, 20214, 15); //Chocolate Cookie 
		}
		else
		{
	...
	//White Day Solo Package 
		public void ItemHandler_14768(L2Player player, Boolean ctrl)
	{
		if(player == null)
		{
			return;
		}
		if(!canBeExtracted(14768, player))
		{
			return;
		}
		removeItem(player, 14768, 1);
		if(Rnd.chance(100))
		{
			addItem(player, 14770, 1); // Solo Escape Petition 
		} 
		if(Rnd.chance(80))
		{
			addItem(player, 14774, 1); // Wild Rose Pig Candy 14 day limited period 
		}
		else
		{
			player.sendPacket(Msg.THERE_WAS_NOTHING_FOUND_INSIDE_OF_THAT);
	...
	public void ItemHandler_14832(L2Player player, Boolean ctrl)
	{
		...
		if(((L2MonsterInstance) object).getNpcId() == 18795)
	...
	public void ItemHandler_14833(L2Player player, Boolean ctrl)
	{
		...
		int[] list = new int[]
			...
			{
				9575, 10485, 10577, 14209, 14208, 14212, 960, 9625, 9626, 959, 10373, 10374, 10375, 10376, 10377, 10378, 10379, 10380, 10381
			};
		int[] counts = new int[]
	...
	//: Class Equipment Set 10 day limited period :\\
											//Kamael\\
		public void ItemHandler_15198(L2Player player, Boolean ctrl)
	{
		if(player == null)
		{
			return;
		}
		if(!canBeExtracted(15198, player))
		{
			return;
		}
		removeItem(player, 15198, 1);
		// Dark Crystal Light Armor of Friendship Set Pack 10 day limited period
			if(Rnd.chance(100))
			{
		...
		{
			// Sealed Set of Friendship 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15272, 1);
			}
			// Black Ore Set of Friendship 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15271, 1);
			}
			//	Majestic Set of Friendship 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15270, 1);
			}
			//	Crossbow of Friendship Set 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15245, 1);
			}
			//	Short Sword of Friendship Set 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15244, 1);
			}
			//	Ancient Sword of Friendship Set 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15243, 1);
			}
			//	Manticore Leather of Friendship Set Pack 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15229, 1);
			}
			//	Plate Leather of Friendship Set Pack 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15228, 1);
			}
			//	Leather Armor of Doom of Friendship Set Pack 10 day limited period
			if(Rnd.chance(100))
			{
				addItem(player, 15227, 1);
			}
			//	Elven Set of Friendship 10 day limited period
			if(Rnd.chance(100))
			{
