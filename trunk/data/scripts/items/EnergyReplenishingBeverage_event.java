 ...
 * @author SYS
 */
public class EnergyReplenishingBeverage_event implements IItemHandler, ScriptFile
{
	private static final int[] _itemIds = {14068};
	...
	public void useItem(L2Playable playable, L2ItemInstance item, Boolean ctrl)
	{
		...
		Functions.removeItem(player, 14068, 1);
	}
